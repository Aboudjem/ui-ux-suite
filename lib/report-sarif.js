...
/**
 * SARIF wants a forward-slash relative URI. `evidence.file` is already relative
 * (lib/located-audit.js stores the `rel` path), so this only normalises separators and
 * strips a leading "./".
 */
function toUri(file) {
