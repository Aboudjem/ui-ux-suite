...
function createFinding({ dimension, severity, title, description, impact, fix, effort, before, after }) {
  return {
...
function createProjectProfile() {
  return {
    ...
    styling: null,         // tailwind, css-modules, styled-components, scss, css-in-js, vanilla
    componentLib: null,    // shadcn, mui, chakra, ant, radix, mantine, custom, none
    themeSystem: null,     // css-vars, tailwind-config, token-files, theme-provider, none
